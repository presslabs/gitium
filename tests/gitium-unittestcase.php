<?php class Gitium_UnitTestCase extends WP_UnitTestCase {
	...
	protected function _add_uncommited_changes_locally( $change = 'local', $commit = FALSE ) {
		global $git;
	...
	protected function _add_uncommited_changes_remotely( $change = 'remote', $commit = FALSE ) {
